...
public class ClientB extends MessageServerTcpClient{
	
	public ClientB(String server_ip, String server_name) {
		super(server_ip, server_name,"clientB");
	...
	public static void main(String[] args) {
		ClientB ca=new ClientB("127.0.0.1",MessageConfig.server_name);
		ca.work();
		...
		while (true) {
			...
			Message msg = new Message("clientB","login","msg",bs);
			ca.send(msg);
		}
	}
}
