...
public class MessageManager {
	/** 管理实体也是一个特殊的客户端 */
	public MessageServerClient manager = null;
	/** 消息服务器的IP */
	...
	/** 构造函数 */
	public MessageManager(String server_ip,int port)
	{
		MyPrint.print("", new Exception());
		this.server_ip = server_ip;
		this.port = port;
		manager = new MessageServerClient(server_ip,port,"manager");
	...
	public static void main(String[] args) {
		...
		MessageManager m = new MessageManager(server_ip, port);
		// m.build_menu();
		while (true) {
			m.input_main();
		}
